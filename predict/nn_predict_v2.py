...
def features_extract():
  ...
  vid_hashed = feature_column.categorical_column_with_hash_bucket('fullvisitorid', hash_bucket_size=100000)
  pid_hashed = feature_column.categorical_column_with_hash_bucket('productsku', hash_bucket_size=5000)
...
model_dir = "../model/unice_rank_model_v2_1_{}".format(cur_time)
