...
parse.add_argument('--start_date', type=str, default='20220731')
...
def train_process(data_path, cur_time, model_dir):
    ...
    model_dir_new = "../model/unice_rank_model_v2_{}".format(cur_time)
...
if __name__ == '__main__':
    ...
    for i in range(0, date_num):
        ...
        cur_model_path = '../model/unice_rank_model_v2_{}'.format(date)
        if os.path.exists(data_path):
            ...
            if args.retrain == True:
                ...
                for i in range(1, deltas):
                    model_time = (
                                datetime.datetime.strptime(model_time, '%Y%m%d') - datetime.timedelta(days=i)).strftime(
                        "%Y%m%d")
                    model_dir = "../model/unice_rank_model_v2_{}".format(model_time)
