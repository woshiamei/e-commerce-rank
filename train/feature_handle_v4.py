...
def features_extract():
    ...
    # id 类列
    uid_hashed = feature_column.categorical_column_with_hash_bucket('id', hash_bucket_size=2000000)
    vid_hashed = feature_column.categorical_column_with_hash_bucket('fullvisitorid', hash_bucket_size=3000000)
...
def features_extract_2():
    ...
    vid_embedding = feature_column.embedding_column(vid_hashed, dimension=16)
    # pid_embedding = feature_column.embedding_column(pid_hashed, dimension=16)
    feature_columns.extend([vid_embedding])
