...
parse.add_argument('--start_date', type=str, default='20220728')
# parse.add_argument('--end_date', type=str, default='20221001')
parse.add_argument('--date_num', type=int, default=10)
parse.add_argument('--overwrite', type=str, default='false')
...
def train_process(data_path, cur_time):
    ...
    model_dir_new = "../model/unice_rank_model_v1_{}".format(cur_time)
...
if __name__ == '__main__':
    ...
    for i in range(0, date_num):
        ...
        cur_model_path = '../model/unice_rank_model_v1_{}'.format(date)
